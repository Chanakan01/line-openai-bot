...
- ตอบเป็นภาษาไทยที่เข้าใจง่าย หรือหากผู้ใช้ต้องการคุยภาษาอังกฤษคุณก็ต้องสื่อสารได้
            `.trim()
          },
          {
            role: "user",
  ...
  return {
    items: [
      ...
      },
      {
        ...
        action: {
          type: "message",
          label: "🎬 รายการหนังที่กำลังจะเข้า Netflix เร็วๆนี้",
          text: "รายการหนังที่กำลังจะเข้า Netflix เร็วๆนี้"
        }
      },
      {
        type: "action",
