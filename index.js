        ...
        await replyLINE(event.replyToken, [
          {
            type: "text",
            text:
              "สวัสดีครับ ผม Arvin ผู้ช่วยอัจฉริยะของคุณเอง 🤖💙\n\nวิธีใช้คร่าว ๆ:\n• พิมพ์ถามการบ้าน / งานต่าง ๆ ได้เลย เช่น \"ช่วยติวเคมีให้หน่อย\"\n• ขอให้วาดรูปได้ เช่น \"วาดรูปแมวใส่ชุดนักเรียน\" ผมจะสร้างรูปให้\n• ส่งรูปใบงาน / สลิป / เอกสารมา ผมช่วยอ่านและสรุปให้ได้\n• ถ้าอยากรู้ข่าวหรือสถานการณ์ปัจจุบัน ก็ถามได้เลย เช่น \"สรุปข่าววันนี้ให้หน่อย\"\n• ถ้ารู้สึกว่าบอทเริ่มงง คุยวกวน พิมพ์ /reset เพื่อล้างประวัติแล้วเริ่มใหม่ได้ครับ ✨",
